...
![Snippet: Conversión de String a LocalDate y a Date, y visceversa](/assets/blogger/Duke_8-copy-300x196.png)
...
Pues bien, la manipulación de días, meses, semanas, etc es más efectivo y cómodo con el nuevo tipo de Java 8 llamado [java.time.LocalDate](http://docs.oracle.com/javase/8/docs/api/java/time/LocalDate.html) como lo mencioné en un post anterior: [Paquete java.time de Java 8: Fechas y Horas](/2014/09/paquete-javatime-de-java8-fechas-y-horas.html).
